 ...
 *
 * @wordpress-plugin
 * Plugin Name:       SFDC CUSTOM JSON INFO
 * Plugin URI:        https://github.com/Softdiscover/sfdc-custom-jsoninfo
 * Description:       Show users in a random link
 * Version:           1.0.0
...
function activate_plugin_name() {
	...
	\sfdc\wpJsonPlaceholder\includes\PluginNameActivator::activate();
}
...
function deactivate_plugin_name() {
	...
	\sfdc\wpJsonPlaceholder\includes\PluginNameDeactivator::deactivate();
}
...
function run_plugin_name() {
	...
	$plugin = new \sfdc\wpJsonPlaceholder\includes\PluginName();
	$plugin->run();
